...
import { sixthParaData3 } from "../../assests/data/componentdata"; 
      ...
      <div className="row align-items-center mt-3">
        <div className="col-sm-10 lormips">
          <div className="" style={{ paddingLeft: "40px" }}>
            <h2 className="onbord mb-4">{sixthParaData3.title}</h2>
            <p className="skills_para mb-4">{sixthParaData3.paragraph}</p>
            <Link
              to={sixthParaData3.linkTo}
              onClick={handleClick}
              className="mil-links mil-dark mil-arrow-place mil-up">
              <span className="mil-label mil-upper mil-accent text-grey">
                {sixthParaData3.linkText}
              </span>
