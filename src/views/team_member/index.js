            ...
            >
              <div class="mil-animation-frame">
                <div
                  ...
                  style={{
                    transform:
                      "translate3d(0px, 0px, 0px) scale(1.9513, 1.9513)",
                    WebkitTransform:
                      "translate3d(0px, 0px, 0px) scale(1.9513, 1.9513)",
                  }}
                >
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                  ...
                  >
                    ...
                    <div class="mil-description">
                      <div class="mil-secrc-text">
                        <h5 class="mil-muted mil-mb-5">
                          <a href="home-2.html">Tom Oldman</a>
                        </h5>
                        <p class="mil-link mil-light-soft mil-mb-10">
                          Art Director
                        </p>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                  ...
                  >
                    ...
                    <div class="mil-description">
                      <div class="mil-secrc-text">
                        <h5 class="mil-muted mil-mb-5">
                          <a href="home-2.html">Corey Trueman</a>
                        </h5>
                        <p class="mil-link mil-light-soft mil-mb-10">
                          Art Director
                        </p>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                  ...
                  >
                    ...
                    <div class="mil-description">
                      <div class="mil-secrc-text">
                        <h5 class="mil-muted mil-mb-5">
                          <a href="home-2.html">Justin Newman</a>
                        </h5>
                        <p class="mil-link mil-light-soft mil-mb-10">
                          Art Director
                        </p>
