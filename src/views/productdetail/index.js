...
import image1 from "../../assests/images/work/6.jpg";
          ...
          <div className="container mt-3 mb-3">
            ...
            >
              <div className="text-white">
                Client: &nbsp;<span className="">Envato Market</span>
              </div>
              <div className="text-white">
                Date: &nbsp;<span className="">April 2023</span>
              </div>
              <div className="text-white">
                Author: &nbsp;<span className="">Paul Trueman</span>
              </div>
            </div>
          </div>
              ...
              <div className="row justify-content-between">
                ...
                <div className="col-lg-6 text-white">
                  <p className="mil-up mil-mb-30">
                    ...
                    an open and closed mode, we define the product to have clear
